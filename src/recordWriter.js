...
var writeEvent = new stream_1.EventEmitter();
/*
 ...
 */
function writer(session) {
    writeEvent.emit('write', session);
}
exports.writer = writer;
// Notion database writer
writeEvent.on('write', function (session) { return __awaiter(void 0, void 0, void 0, function () {
    var notion, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                notion = new client_1.Client({ auth: config_json_1.default.writer.notion.apiKey });
                return [4 /*yield*/, notion.pages.create({
                        "parent": {
                            "type": "database_id",
                            "database_id": config_json_1.default.writer.notion.databaseId
                        },
                        "properties": {
                            "Amount": {
                                "type": "number",
